...
Some interesting results are shown in Table~\ref{tab:finllm_comparison, tab:fiqa_results, tab:headline_classification, tab:ner_few_shot_performance}.
...
The model exhibited a remarkable ability to outperform existing models on financial NLP tasks, a testament to the efficacy of its specialized training as shown in Tables~\ref{tab:financial_tasks, tab:internal_aspect_sentiment, tab:ner_ned_results}.
