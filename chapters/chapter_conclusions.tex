...
Latest model, like OpenAI's o1 and o3 or Claude 3.5 Sonnet shows some advancements in this direction, making the model more capable of reasoning and planning but still far from AGI\@.
