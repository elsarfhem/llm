...
From language generation to sentiment analysis, question-answering, and summarisation, larger models consistently outperform their smaller counterparts.
...
This allowed making predictions about the expected performance of GPT-4 (based on small runs trained in similar ways) that were tested against the final run to increase confidence in our training.
