...
}\footnote{dalal2024blackboxstatisticalmodel} and constructed a synthetic dataset to prove that the ICL ability emerges when the pretraining distribution follows a mixture of hidden Markov models.
...
As confirmed by our experiments in Chapter~\ref{ch:capabilities}, PoT can significantly improve performance on math problems compared to CoT\@.
