...
We also provided some references to approaches that integrates LLMs into larger echo-systems, LLM-Modulo framework in planning and RAG for retrieval augmented generation.

\subsection*{Reflection on Capabilities and Limitations}
...
Latest models from OpenAI, Anthropic and others shows some advancements in this direction, making the model more capable of reasoning and planning, even though they still show some notable limitations which raises the question if we are in front of just a small improvement step or a real breakthrough in advancing towards AGI\@.
